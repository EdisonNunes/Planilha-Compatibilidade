...
class Planilha(Base):
    ...
    tipo = Column("tipo", String())                     # Tipo de Membrana
    ...
    sala_temp  = Column("sala_temp", String())          # Temperatura Inicial
    sala_tempf = Column("sala_tempf", String())         # Temperatura Final
    sala_umid = Column("sala_umid", String())           # Umidade Inicial
    sala_umidf = Column("sala_umidf", String())         # Umidade Final
